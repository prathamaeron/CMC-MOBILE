...
const Calculate = ({navigation, route}) => {
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={{marginTop: 20, marginHorizontal: 20}}>
            ...
            <Paragraph>
                This is a Beta version of the Car Motion Calculator application. No input in the fields above might lead to miscalculations. If you see NaN in the results tab, it means you have missed a value by mistake.
            </Paragraph>
        </View>
