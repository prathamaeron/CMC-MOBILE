...
const Info = ({navigation, route}) => {
    ...
    distance += results[0].velocityTable[i] * results[0].time[i]
    console.log(distance)
    }
    var avg = total / results[0].velocityTable.length;
    console.log([avg, results[0].velocityTable.length])
  ...
  <DataTable>
    ...
    <DataTable.Row>
      ...
      <DataTable.Cell numeric>#TODO m/s</DataTable.Cell>
    </DataTable.Row>

    <DataTable.Row>
      <DataTable.Cell>Maximum Velocity</DataTable.Cell>
      <DataTable.Cell numeric>#TODO m/s</DataTable.Cell>
    </DataTable.Row>
